...
struct SettingsView: View {
            ...
            keychain.authenticateWithBiometrics(reason: "Access your stored API key") { [self] success, error in
                DispatchQueue.main.async {
                    ...
                    if success {
                        ...
                        if let storedKey = keychain.get(forKey: KeychainHelper.openAIAPIKey, prompt: "Access your API key") {
    ...
    private func clearAPIKey() {
        ...
        if useBiometric && keychain.isBiometricAuthenticationAvailable() {
            ...
            keychain.authenticateWithBiometrics(reason: "Remove your API key from secure storage") { [self] success, error in
                DispatchQueue.main.async {
                    isAuthenticating = false
