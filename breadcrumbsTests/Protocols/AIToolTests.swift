...
final class AIToolTests: XCTestCase {
    ...
    func testAIToolConformance() {
        ...
        struct TestAITool: AITool {
            ...
            let parametersSchema: ToolParameterSchema = ToolParameterSchema([
                "type": "object",
                "properties": [
                    "param1": [
                        "type": "string",
    ...
    func testToolRegistryExecuteToolNotFound() async {
        ...
        // When & Then
        do {
            let _ = try await registry.executeTool(name: "nonexistent_tool", arguments: arguments)
            XCTFail("Should have thrown an error")
        } catch ToolError.toolNotFound(let toolName) {
